    ...
    return (
        <div>
            ...
            <div className="flex justify-between items-center mb-6">
                <div>
                    <h1 className="text-2xl font-bold text-gray-800">Hoạt động hợp tác</h1>
                ...
                <div className="bg-gradient-to-br from-green-50 to-green-100/50 rounded-2xl p-5 border border-green-100">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <div className="text-xs text-green-600/70">Đang hoạt động</div>
                        </div>
                    </div>
                </div>
                <div className="bg-gradient-to-br from-blue-50 to-blue-100/50 rounded-2xl p-5 border border-blue-100">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <div className="text-xs text-blue-600/70">Hoàn thành</div>
                        </div>
                    </div>
                </div>
                <div className="bg-gradient-to-br from-orange-50 to-orange-100/50 rounded-2xl p-5 border border-orange-100">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <div className="text-xs text-orange-600/70">Chờ triển khai</div>
                        </div>
                    </div>
                </div>
                <div className="bg-gradient-to-br from-purple-50 to-purple-100/50 rounded-2xl p-5 border border-purple-100">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <div className="text-xs text-purple-600/70">Sinh viên tham gia</div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            {/* Search + Filters */}
            <div className="bg-white rounded-xl p-4 mb-6 shadow-sm border border-gray-100 flex flex-wrap items-center gap-3">
                <Input
                    ...
                    allowClear
                />
                <Select placeholder="Tất cả loại" allowClear onChange={v => setFilterType(v)} value={filterType} className="w-44">
                ...
                <Select placeholder="Tất cả trạng thái" allowClear onChange={v => setFilterStatus(v)} value={filterStatus} className="w-44">
                ...
                <div className="flex border border-gray-200 rounded-lg overflow-hidden">
                    <button onClick={() => setViewMode('grid')} className={`p-2 px-3 ${viewMode === 'grid' ? 'bg-gray-100 text-gray-800' : 'text-gray-400 hover:text-gray-600'}`}>
                        <AppstoreOutlined />
                    </button>
                    <button onClick={() => setViewMode('list')} className={`p-2 px-3 ${viewMode === 'list' ? 'bg-gray-100 text-gray-800' : 'text-gray-400 hover:text-gray-600'}`}>
                            ...
                            <Col xs={24} sm={viewMode === 'list' ? 24 : 12} lg={viewMode === 'list' ? 24 : 8} key={item.id}>
                                <div className="bg-white rounded-2xl border border-gray-100 shadow-sm hover:shadow-md transition-all h-full flex flex-col overflow-hidden group">
                                    ...
                                    <div className="p-5 pb-3 flex-1">
                                        <div className="flex justify-between items-start mb-3">
                                            <div className="flex items-start gap-3 flex-1">
                                                ...
                                                <div className="flex-1 min-w-0">
                                                    <h3 className="font-bold text-gray-800 text-[15px] leading-snug line-clamp-2 mb-1">
                                                        {item.title}
                                                    </h3>
                                        ...
                                        {/* Description */}
                                        {item.description && (
                                            <p className="text-gray-400 text-xs leading-relaxed line-clamp-2 mb-3 ml-[52px]">
                                                {item.description}
                                            </p>
                                        )}

                                        {/* Meta info */}
                                        <div className="flex items-center gap-4 text-xs text-gray-400 mb-3 ml-[52px]">
                                    ...
                                    <div className="px-5 py-3 border-t border-gray-50 flex items-center justify-between bg-gray-50/50">
                                        ...
                                        <div className="flex gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
                                            <Tooltip title="Chỉnh sửa">
                                                <button className="w-7 h-7 rounded-lg flex items-center justify-center text-gray-400 hover:text-blue-500 hover:bg-blue-50 transition-all"
                                                    onClick={() => {
                                            ...
                                            <Tooltip title="Xóa">
                                                <button className="w-7 h-7 rounded-lg flex items-center justify-center text-gray-400 hover:text-red-500 hover:bg-red-50 transition-all"
