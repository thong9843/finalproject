# Không gian Ghi chú dán (Ghi chú - Sticky Notes)

Không gian Ghi chú giúp lưu trữ nhanh các mảnh ghi chép, ý tưởng hoặc thông tin liên lạc khẩn cấp bằng các thẻ dán màu sắc (Google Keep style).

---

## 📋 Tạo mới và Sắp xếp Ghi chú
...
## 🏷️ Thẻ Badge thực thể liên kết thông minh
...
## 🤖 Trò chuyện với trợ lý AI (RobotOutlined)
