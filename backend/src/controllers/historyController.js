    ...
    try {
        ...
        // --- RESTORE UPDATE OPERATION ---
            ...
            if (entityType === 'ENTERPRISE') {
                ...
                await conn.query(
                    `UPDATE mous SET mou_code=?, enterprise_id=?, signing_date=?, end_date=?, partner_contact=?,
                    ...
                    [mou.mou_code, mou.enterprise_id, mou.signing_date, mou.end_date || null, mou.partner_contact,
