...
exports.getEnterpriseRatings = async (req, res) => {
    try {
        ...
        const [ratings] = await pool.query(
            'SELECT r.*, a.title as activity_name FROM enterprise_ratings r LEFT JOIN activities a ON r.activity_id = a.id WHERE r.enterprise_id = ? ORDER BY r.created_at DESC',
            [enterpriseId]
        );
