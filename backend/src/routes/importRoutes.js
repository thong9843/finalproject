...
const { upload, importEnterprises, importActivities, importStudents, importMous, aiParseRow, validateEnterprises, validateActivities, validateMous, validateStudents, validateActivityStudents, importActivityStudents } = require('../controllers/importController');
...
router.post('/activity-students', upload.single('file'), verifyRole(['ADMIN', 'FACULTY_MANAGER']), importActivityStudents);
...
router.post('/activity-students/validate', verifyRole(['ADMIN', 'FACULTY_MANAGER']), validateActivityStudents);
